    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                <br />
                <Email></Email><div className="input-wrapper"> <input type="text" className="contact-mail-input" onChange={handleEmailChange} value={email} placeholder='this email' /></div>
                <br />
