        ...
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                <div className={styles['add-city']}>
                    ...
                    <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-medium']} ${styles['contact-name-input']}`} onChange={handleAddressChange} value={address} placeholder='ex: apt, suite, etc' /></div>
                    State:
                    <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-short']} ${styles['contact-name-input']}`} onChange={handleAddressChange} value={address} /></div>
                </div>
