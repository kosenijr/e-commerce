    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                Name:
                <div className={styles}> <input type="text" className="contact-name-input" onChange={handleNameChange} value={name} placeholder='please enter your full name' /></div>
                <br />
                Email:
                <div className={styles}> <input type="text" className="contact-mail-input" onChange={handleEmailChange} value={email} placeholder='please enter your email' /></div>
                <br />
                Text:
                <div className={styles}> <input type="text" className="contact-message-input" onChange={handleNumberChange} value={number} placeholder='what number is best for text?' /></div>
                <br />
                <div className={styles['inputs-container']}>
                    ...
                    <div>
                        ...
                        <input type="radio" id="text" name="drone" value="electText" />
