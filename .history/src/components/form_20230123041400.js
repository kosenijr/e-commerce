    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                Email:
                <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-long']} ${styles['contact-name-input']}`} onChange={handleEmailChange} value={email} placeholder='ex: myname' /></div>
                Text:
