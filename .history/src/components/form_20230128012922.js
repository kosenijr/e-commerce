    ...
    return (
        <div className={styles['form-container']}>
            <div className={styles['form-statement']}>
                <h3 className={styles[onFormSelection ? 'form-header-off' : 'form-header-on']}>
                    Please subscribe to stay informed:
                </h3>
            </div>
            <div className={`${styles['form-intake']} ${styles[onFormSelection ? 'form-header-off' : 'form-header-on']}`} >
