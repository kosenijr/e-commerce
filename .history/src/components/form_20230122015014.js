    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                <br />
                Text:
                <div className={styles['input-wrapper']}> <input type="text" className="contact-number-input" onChange={handleNumberChange} value={number} placeholder='please enter phone number' /></div>
                <br />
                Do you prefer an email or text notification?
                <div className={styles['inputs-container']} onChange={handleNoticeChange} value={}>
                    <div>
                ...
                <br />
                Address:
                <div className={styles['input-wrapper']}> <input type="text" className="contact-address-input" onChange={handleNumberChange} value={number} placeholder='please enter your address' /></div>
                <br />
