    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                Email:
                <div className={styles['input-wrapper']}> <input type="text"  className={`${styles['contact-long']} ${styles['contact-name-input']}`} onChange={handleEmailChange} value={email} placeholder='please enter your email' /></div>
                Text:
                <div className={styles['input-wrapper']}> <input type="text"  className={`${styles['contact-long']} ${styles['contact-name-input']}`} onChange={handleNumberChange} value={number} placeholder='please enter your phone number' /></div>
                <b />
                ...
                <div className={styles['input-wrapper']}> <input type="text"  className={`${styles['contact-m']} ${styles['contact-name-input']}`} onChange={handleAddressChange} value={address} placeholder='please enter your address' /></div>
                ...
                State:
                <div className={styles['input-wrapper']}> <input type="text"  className={`${styles['contact-long']} ${styles['contact-name-input']}`} onChange={handleAddressChange} value=
