    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                <br />
                Text:
                <div className={styles['input-wrapper']}> <input type="text" className="contact-message-input" onChange={handleNumberChange} value={number} placeholder='phone number for text' /></div>
                <br />
