...
const Form = () => {
    ...
    // name, email, text number, notification, addressOne, addressTwo (optional), 
    ...
    return (
        <div className={styles['form-container']}>
            ...
            <div className={styles['form-intake']}>
                ...
                <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-long']} ${styles['contact-address-1-input']}`} onChange={handleAddressOneChange} value={addressOne} placeholder='please enter your address' /></div>

                <div className={styles['add-city']}>
                    Address Line 2 (optional):
                    <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-medium']} ${styles['contact-address-2-input']}`} onChange={handleAddressTwoChange} value={addressTwo} placeholder='Apt, Suite, etc.' /></div>
                    City:
                ...
                <div className={styles['state-zip']}>
                    State:
                    <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-short']} ${styles['contact-name-input']}`} onChange={handleStateChange} value={state} /></div>
                    ZIP Code:
                    <div className={styles['input-wrapper']}> <input type="text" className={`${styles['contact-short']} ${styles['contact-name-input']}`} onChange={handleZipChange} value={zip} /></div>
                </div>
