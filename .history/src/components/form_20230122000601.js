    ...
    return (
        <div className={styles['form-container']}>
            ...
            Hello,
                        ...
                        <br />
                        I'd like to leave <div className="input-wrapper"> <input type="text" className="contact-message-input" onChange={handleNumberChange} value={message} placeholder='this message' /></div>
                        <br />
