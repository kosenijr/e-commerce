...
const Form = ({ onFormSection, onHandleThanks }) => {
  ...
  const [notice, setNotice] =
    useState(0); /* 1 should be email, 2 should be text */
  ...
  return (
    <div className={`${styles["form-container"]} ${styles[formDisplay ? "form-display-on" : "form-display-off"]}`}>
      <div className={styles["form-statement"]}>
        <h3
          className={
            styles[onFormSection ? "form-header-on" : "form-header-off"]
          }
        >
      ...
      <div
        className={styles[onFormSection ? "form-intake-on" : "form-intake-off"]}
      >
        Name:
        <div className={styles["input-wrapper"]}>
          ...
          <input
            type="text"
            className={`${styles["contact-long"]} ${styles["contact-name-input"]}`}
        ...
        <div className={styles["input-wrapper"]}>
          ...
          <input
            type="text"
            className={`${styles["contact-long"]} ${styles["contact-email-input"]}`}
        ...
        <div className={styles["input-wrapper"]}>
          ...
          <input
            type="text"
            className={`${styles["contact-medium"]} ${styles["contact-number-input"]}`}
        ...
        <div className={styles["input-wrapper"]}>
          ...
          <input
            type="text"
            className={`${styles["contact-long"]} ${styles["contact-address-one-input"]}`}
        ...
        <div className={styles["add-city"]}>
          <div className={styles["address-two-div"]}>
            ...
            <div className={styles["input-wrapper"]}>
              ...
              <input
                type="text"
                className={`${styles["contact-medium"]} ${styles["contact-address-two-input"]}`}
          ...
          <div className={styles["city-div"]}>
            ...
            <div className={styles["input-wrapper"]}>
              ...
              <input
                type="text"
                className={`${styles["contact-short"]} ${styles["contact-city-input"]}`}
        ...
        <div className={styles["state-zip"]}>
          <div className={styles["state-div"]}>
            ...
            <div className={styles["input-wrapper"]}>
              ...
              <input
                type="text"
                className={`${styles["contact-short"]} ${styles["contact-state-input"]}`}
          ...
          <div className={styles["zip-div"]}>
            ...
            <div className={styles["input-wrapper"]}>
              ...
              <input
                type="text"
                className={`${styles["contact-short"]} ${styles["contact-zip-input"]}`}
